            ...
            return CompletableFuture.completedFuture("""
                    {
                      ...
                      "questions": [
                        {"source": "LIKELY", "question": "(개발용 임시) 연락이 없다는 건 마음이 식었다는 뜻일까?", "answer": "(개발용 임시) 요청된 거리두기 기간의 무연락은 독립적인 거절 신호가 아닙니다.", "reading": "(개발용 임시) 스스로 요청한 기간을 지키는 행동이라, 기간이 끝난 뒤의 선택이 진짜 신호입니다.", "evidenceIds": ["F01"]}
                      ],
                      "blockers": [
                      ...
                      "relationshipRepair": {"title": "(개발용 임시) 다시 만나면 같은 문제가 반복될까?", "answer": "(개발용 임시) 갈등을 다루는 방식이 달라지지 않으면 반복 위험이 있습니다.", "concept": "확인-거리두기", "reading": "(개발용 임시) 한쪽의 미표현이 상대의 불안을 자극하고 그 반응이 다시 압박이 되는 순환이 이번 갈등에서 한 번 나타났습니다. 반복 근거는 없어 고정 패턴이라 단정할 단계는 아닙니다.", "repairPrinciple": "(개발용 임시) 즉각적인 확답 요구보다 감정을 먼저 언어화하고, 불편함을 쌓아두지 않고 다룰 수 있는 대화 방식이 필요합니다."},
