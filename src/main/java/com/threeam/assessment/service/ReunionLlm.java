...
public class ReunionLlm {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            감점 신호의 자격 — 확률을 움직이는 '사실'만:
            - 감점은 재회 성사 확률을 낮추는 사실에만 매겨라. 도덕적 평가("결격 사유"),
              법적/사회적 리스크 경고, "만나면 안 된다"는 당위는 감점이 아니다.
              그런 우려는 reason에 한 줄로만 담아라.
            - signal과 evidence는 비난이 아니라 확률의 언어로 써라.
            ...
            같은 건 가점이 아니다. 상대가 다른 관계(배우자 등)를 정리하지 않은 채 매달리는 것도
            가점이 아니다 — 그건 유지하고 싶은 거지 복원하려는 게 아니다.
            확실한 행동이 없으면 빈 배열 — 억지로 채우지 마라.
            """;
