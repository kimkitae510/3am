...
const BIZ = {
  ...
  ceo: '김도아',
  bizNo: '281-20-02774',
  // 직전년도 통신판매 거래가 50회 미만이면 신고 의무가 면제된다(전자상거래법 시행령 6조).
  // 빈칸이나 "신고 후 기재"를 노출하면 해야 할 걸 안 한 사업자로 읽힌다 — 사유를 밝힌다.
  // 거래가 50회를 넘으면 신고하고 이 값을 신고번호로 바꾼다.
  mailOrderNo: '면제 대상(직전년도 거래 50회 미만)',
  address: '대구광역시 달성군 다사읍 대실역북로1길 6, 106동 301호',
  tel: '010-3449-6662', // 연락처 — 소비자가 실제로 닿을 수 있는 번호여야 한다
