        ...
        {showHelp && (
          <HelpModal
            ...
            sections={[
              ...
              {
                heading: '대화 횟수',
                text: '가입하면 대화 5회와 진단 1회를 선물로 드립니다. 횟수는 기한 없이 남아 있고, 다 쓰면 위 카드 모양 버튼에서 충전할 수 있습니다. 한 번에 2000자까지 보낼 수 있으며 500자를 넘으면 500자마다 대화 1회로 계산됩니다(예: 1200자는 3회). 몇 회가 차감될지는 입력창 위에 미리 표시됩니다.',
              },
              {
                heading: '진단',
